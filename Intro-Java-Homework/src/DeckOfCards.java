...
public class DeckOfCards {
	public static void main(String[] args) {
		try {
			...
			PdfWriter.getInstance(pdfDoc, new FileOutputStream("Playing-Cards-Deck.pdf"));
			...
			//FONT
			BaseFont fontFamily = BaseFont.createFont("./font/times.ttf",BaseFont.IDENTITY_H, true);
			...
			for (int sign = 0; sign < 4; sign++) {
				switch (sign) {
					case 0: cardSign = '♠'; color = blackColor; break;
					case 1: cardSign = '♥'; color = redColor; break;
					case 2: cardSign = '♦'; color = redColor; break;
					case 3: cardSign = '♣'; color = blackColor;
						cardsBody.getDefaultCell()
						.setBorderWidthBottom(0.5f); break;
				}
				...
				for (int card = 2; card <= 14; card++) {
					...
					cardsBody.addCell(new Paragraph(cardValue + cardSign + "",color));
				}
			}
